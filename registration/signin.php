...
<body>
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid d-flex justify-content-between">
            ...
            <span class="navbar-text">
                <a href="admin_login.html"><button type="button" class="btn btn-success">Admin Login</button></a>
            </span>
        </div>
    </nav>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="container mt-5">
        ...
        <br><br>
        <div>
            <a href="signup.php" class="btn btn-success">Don't have an account ? Sign Up</a>
        </div>
    </form>
